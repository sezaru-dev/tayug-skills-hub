...
export default function Loading() {
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-12 space-y-8 sm:space-y-10">
      
      {/* Header */}
      <section className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
        {/* Avatar */}
        <Skeleton className="h-24 w-24 sm:h-32 sm:w-32 md:h-36 md:w-36 rounded-full" />
